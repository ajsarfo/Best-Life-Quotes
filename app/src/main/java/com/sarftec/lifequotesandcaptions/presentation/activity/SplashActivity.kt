...
import com.sarftec.lifequotesandcaptions.databinding.ActivitySplashBinding
...
class SplashActivity : BaseActivity() {
    ...
    private class SplashManager(private val context: Context) {
        ...
        val message = arrayOf(
            ...
            "Failure is the just the opportunity to begin again, this time more intelligently" to "Failure Quotes",
            ...
            "Love is a choice you make from moment to moment" to "Love Quotes",
